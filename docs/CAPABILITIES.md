...
| Provider-neutral semantic authoring | Run a bounded P55 evidence pack through Codex 5.3 Spark or local LM Studio and retain only an evidence-bound semantic proposal. | [`SEMANTIC_AUTHOR_PASS.md`](SEMANTIC_AUTHOR_PASS.md) |
| Experimental-intent decision policy | Require evidence-grounded comparison before generic observed-intent reuse and permit at most one digest-bound, package-neutral experimental proposal when nearby intents are insufficient. | [`EXPERIMENTAL_INTENT_DECISION_POLICY.md`](EXPERIMENTAL_INTENT_DECISION_POLICY.md) |
| Relevant observed-intent routing | Select up to 16 positively matched observed SpecPM intents from a pinned non-canonical snapshot and reject specific-purpose proposals that reuse only generic implementation-shape intents. | [`RELEVANT_INTENT_ROUTING.md`](RELEVANT_INTENT_ROUTING.md) |
| Targeted experimental-intent calibration | Runs Codex 5.3 Spark over four pinned semantic-gap targets and measures useful novelty, justified reuse, differentiation, false novelty, duplicates, evidence, purpose, and edit burden without granting materialization or publication authority. | [`TARGETED_EXPERIMENTAL_INTENT_CALIBRATION.md`](TARGETED_EXPERIMENTAL_INTENT_CALIBRATION.md) |
| Semantic proposal quality diagnostics | Revalidate P55 semantic proposals, candidate YAML, evidence and intent bindings, and frozen calibration thresholds before reviewer-controlled use. | [`SEMANTIC_PROPOSAL_QUALITY.md`](SEMANTIC_PROPOSAL_QUALITY.md) |
...
| Larger curated corpus source planning | Author a bounded operator-curated larger corpus source plan with manifest criteria, pinned revisions, local checkout requirements, inclusion signals, exclusion stop conditions, and no-authority boundaries before readiness, static-only, or AI-enabled gates run. | [`LARGER_CURATED_CORPUS_SOURCE_PLAN.md`](LARGER_CURATED_CORPUS_SOURCE_PLAN.md) |
| Larger curated corpus checkout readiness | Verify all selected larger-corpus sources have operator-provided pinned local checkouts and matching revisions before allowing the static-only gate. | [`LARGER_CURATED_CORPUS_CHECKOUT_READINESS.md`](LARGER_CURATED_CORPUS_CHECKOUT_READINESS.md) |
| Larger curated corpus static-only gate | Run the larger curated corpus deterministic static-only gate over all 12 selected sources, preserving preview-only candidates, relation proposals, caveats, and no-AI/no-adapter/no-registry-authority boundaries before allowing the AI-enabled proposal-only gate. | [`LARGER_CURATED_CORPUS_STATIC_ONLY_GATE.md`](LARGER_CURATED_CORPUS_STATIC_ONLY_GATE.md) |
| Larger curated corpus AI-enabled gate | Run the larger curated corpus through local LM Studio proposal-only AI draft and enrichment paths, preserving provider metadata, warning/blocker evidence, raw prompt/response/chain-of-thought non-persistence, and no-registry-authority boundaries before output triage. | [`LARGER_CURATED_CORPUS_AI_ENABLED_GATE.md`](LARGER_CURATED_CORPUS_AI_ENABLED_GATE.md) |
| Hyperprompt single-package AI draft fallback | Convert reproducible single-package AI draft JSON repair exhaustion into warning-level proposal-only fallback evidence from deterministic inventory while preserving diagnostics and keeping multi-package malformed output blocking. | [`HYPERPROMPT_AI_DRAFT_SINGLE_PACKAGE_FALLBACK.md`](HYPERPROMPT_AI_DRAFT_SINGLE_PACKAGE_FALLBACK.md) |
| Larger curated corpus output triage | Classify larger curated corpus static packages, relation proposals, AI draft sidecars, AI enrichment sidecars, AI-enriched previews, warnings, and caveats into selected, deferred, and do-not-promote outcomes before the exit decision. | [`LARGER_CURATED_CORPUS_OUTPUT_TRIAGE.md`](LARGER_CURATED_CORPUS_OUTPUT_TRIAGE.md) |
| Larger curated corpus exit decision | Complete Phase 51 as author-review evidence ready without approving further larger corpus expansion, registry promotion, package acceptance, relation acceptance, or `preview_only` removal. | [`LARGER_CURATED_CORPUS_EXIT_DECISION.md`](LARGER_CURATED_CORPUS_EXIT_DECISION.md) |
| Controlled 50-100 repository corpus plan | Define a staged 5/20/50-100 repository rollout, Codex Spark external-model boundary, curated source policy, quality thresholds, and proposal-only gates before new checkout acquisition or batch execution. | [`CONTROLLED_REPOSITORY_CORPUS_PLAN.md`](CONTROLLED_REPOSITORY_CORPUS_PLAN.md) |
| Codex Spark external-model adapter contract | Define the future `codex exec` proposal-only invocation, evidence staging, final-message JSON Schema, receipt and rejection policy, and external `--model-output` handoff without running Codex or replacing LM Studio. | [`CODEX_SPARK_EXTERNAL_MODEL_ADAPTER_CONTRACT.md`](CODEX_SPARK_EXTERNAL_MODEL_ADAPTER_CONTRACT.md) |
| Five-repository controlled calibration | Runs static-only, LM Studio JSON Schema, and read-only schema-validated Codex Spark proposal-only controls over five pinned checkouts; records quality metrics, bounded receipts, external-provider logging caveat, and the P52-T4 decision without registry authority. | [`FIVE_REPOSITORY_CONTROLLED_CALIBRATION.md`](FIVE_REPOSITORY_CONTROLLED_CALIBRATION.md) |
| Twenty-repository controlled pilot | Runs the Phase 52 twenty-source static-first pilot with proposal-only LM Studio and Codex Spark controls, digest-bound author review, and an explicit P52-T5 readiness decision. | [`TWENTY_REPOSITORY_CONTROLLED_PILOT.md`](TWENTY_REPOSITORY_CONTROLLED_PILOT.md) |
| Final corpus checkout readiness | Fixes the final 50-source manifest and verifies clean pinned local checkouts, provenance, license evidence, tracked-file size budgets, and ecosystem/shape coverage before P52-T6. | [`FINAL_CORPUS_CHECKOUT_READINESS.md`](FINAL_CORPUS_CHECKOUT_READINESS.md) |
| Final corpus static-only gate | Runs all 50 approved sources through deterministic static collection and preview drafting, records explicit failures and artifact digests, enforces the 95% completion threshold, and keeps AI and adapters disabled before P52-T7. | [`FINAL_CORPUS_STATIC_ONLY_GATE.md`](FINAL_CORPUS_STATIC_ONLY_GATE.md) |
| Mass repository campaign plan | Defines the 100-source, four-wave campaign contract with `gpt-5.3-codex-spark` as sole proposal-only worker, two-worker concurrency, bounded retries/budgets, explicit scale-out review gates, and no-registry-authority boundaries. | [`MASS_REPOSITORY_CAMPAIGN_PLAN.md`](MASS_REPOSITORY_CAMPAIGN_PLAN.md) |
| Local candidate review Workbench contract | Defines the local-first 100-candidate review product, roles, trust zones, decision lifecycle, hostile-content controls, digest-bound portable input, and read-only SpecPM preflight boundary. | [`LOCAL_CANDIDATE_REVIEW_WORKBENCH_CONTRACT.md`](LOCAL_CANDIDATE_REVIEW_WORKBENCH_CONTRACT.md) |
| Local candidate review Workbench schemas | Defines versioned JSON Schema records for catalog, detail, static-versus-AI comparison, reviewer decisions, reason taxonomy, and portable non-authoritative export. | [`LOCAL_CANDIDATE_REVIEW_WORKBENCH_SCHEMAS.md`](LOCAL_CANDIDATE_REVIEW_WORKBENCH_SCHEMAS.md) |
| Deterministic local candidate review catalog | Safely validates a portable handoff archive and emits a packet-digest-bound static catalog with six review facets. | [`LOCAL_CANDIDATE_REVIEW_CATALOG.md`](LOCAL_CANDIDATE_REVIEW_CATALOG.md) |
| Local candidate review browser | Renders a local candidate-only browser with corpus navigation, human-readable specs, and inert static-versus-AI semantic claim review. | [`LOCAL_CANDIDATE_REVIEW_BROWSER.md`](LOCAL_CANDIDATE_REVIEW_BROWSER.md) |
| Local candidate review details | Builds schema-valid, digest-bound candidate details and static-versus-Codex Spark comparison evidence, then displays selected records as inert local text. | [`LOCAL_CANDIDATE_REVIEW_DETAILS.md`](LOCAL_CANDIDATE_REVIEW_DETAILS.md) |
| Local review decision service | Stores schema-valid catalog-bound candidate and semantic reviewer decisions behind a loopback Origin/CSRF boundary with immutable history and portable evidence-only exchange. | [`LOCAL_REVIEW_DECISION_SERVICE.md`](LOCAL_REVIEW_DECISION_SERVICE.md) |
| Reviewer-controlled semantic materialization | Applies only explicitly accepted or edited semantic claims to a new preview revision with digest provenance and read-only SpecPM validation. | [`REVIEWER_CONTROLLED_SEMANTIC_MATERIALIZATION.md`](REVIEWER_CONTROLLED_SEMANTIC_MATERIALIZATION.md) |
| Targeted semantic quality calibration | Compares provider-separated semantic author quality against frozen purpose, evidence, schema, and reviewer-burden gates before broader corpus execution. | [`TARGETED_SEMANTIC_QUALITY_CALIBRATION.md`](TARGETED_SEMANTIC_QUALITY_CALIBRATION.md) |
| Semantic provider output conformance | Gives Codex Spark and LM Studio one strict transport subset, bounded schema-aware repair, and full post-transport validation before semantic proposals are retained. | [`SEMANTIC_PROVIDER_OUTPUT_CONFORMANCE_FOLLOW_UP.md`](SEMANTIC_PROVIDER_OUTPUT_CONFORMANCE_FOLLOW_UP.md) |
| Retained-corpus semantic campaign | Runs Codex 5.3 Spark over the pinned 100-repository P53 corpus with resumable digest-bound records, deterministic quality diagnostics, portable Workbench proposals, bounded retries, and no materialization or publication authority. | [`RETAINED_CORPUS_SEMANTIC_CAMPAIGN.md`](RETAINED_CORPUS_SEMANTIC_CAMPAIGN.md) |
| Local SpecPM intake bridge | Revalidates current approved reviewer decisions and portable packet bindings, reconstructs preview candidates safely, runs bounded read-only SpecPM validation, and emits non-authoritative intake proposal evidence with zero registry mutations. | [`LOCAL_SPECPM_INTAKE_BRIDGE.md`](LOCAL_SPECPM_INTAKE_BRIDGE.md) |
| Local candidate review Workbench E2E validation | Exercises the full 100-candidate browser, decision, restart, hostile-content, Origin/CSRF, integrity, and read-only SpecPM path across all four campaign waves. | [`LOCAL_CANDIDATE_REVIEW_WORKBENCH_E2E.md`](LOCAL_CANDIDATE_REVIEW_WORKBENCH_E2E.md) |
| AI semantic-author product contract | Defines provider-neutral, evidence-grounded semantic proposal responsibilities for Codex 5.3 Spark and LM Studio, experimental-intent states, explicit reviewer authority, bounded materialization, privacy, and no-publication boundaries. | [`AI_SEMANTIC_AUTHOR_CONTRACT.md`](AI_SEMANTIC_AUTHOR_CONTRACT.md) |
| AI semantic-author schemas | Defines provider-neutral JSON Schema records for semantic requests, proposals, intent reuse and experiments, evidence, reviewer edits, and future proposal-only materialization decisions. | [`AI_SEMANTIC_AUTHOR_SCHEMAS.md`](AI_SEMANTIC_AUTHOR_SCHEMAS.md) |
| Semantic author input pack | Builds a deterministic, bounded, digest-bound P55 request from allowlisted local candidate evidence and observed intents without provider execution. | [`SEMANTIC_AUTHOR_INPUT_PACK.md`](SEMANTIC_AUTHOR_INPUT_PACK.md) |
| Bounded corpus runs | Select important multi-ecosystem repository/package-family targets with explicit importance signals and exclusion rules, record the machine-readable corpus plan, explainable selection report, dry-run readiness gate, P46 bounded popular-library pilot manifest, P46 static-only pilot result, P46 proposal-only AI-enabled pilot result, P46 output triage, P46 author handoff, P46 exit decision, P47 targeted quality follow-up plan, P47 targeted quality pass, P47 bounded rerun gate, P47 targeted quality follow-up exit decision, P48 AI draft blocker follow-up plan, P48 AI draft blocker follow-up pass, P48 bounded rerun gate, P48 post-blocker exit decision, P49 docc2context AI draft targeted follow-up plan, P49 docc2context AI draft targeted follow-up pass, P49 same-scope bounded rerun gate evidence, P49 docc2context follow-up exit decision, P50 restored-checkout rerun evidence, and P51 larger curated corpus planning phase, then run operator-selected local checkout batches with deterministic and optional live local-model paths. | [`CORPUS_SELECTION_POLICY.md`](CORPUS_SELECTION_POLICY.md), [`SPECHARVESTER_CORPUS_PLAN.md`](SPECHARVESTER_CORPUS_PLAN.md), [`MULTI_ECOSYSTEM_SEED_CORPUS_PLAN.md`](MULTI_ECOSYSTEM_SEED_CORPUS_PLAN.md), [`EXPLAINABLE_CORPUS_SELECTION_REPORT.md`](EXPLAINABLE_CORPUS_SELECTION_REPORT.md), [`SELECTED_CORPUS_DRY_RUN_READINESS.md`](SELECTED_CORPUS_DRY_RUN_READINESS.md), [`BOUNDED_POPULAR_LIBRARY_PILOT_MANIFEST.md`](BOUNDED_POPULAR_LIBRARY_PILOT_MANIFEST.md), [`BOUNDED_POPULAR_LIBRARY_PILOT_STATIC_ONLY_RUN.md`](BOUNDED_POPULAR_LIBRARY_PILOT_STATIC_ONLY_RUN.md), [`BOUNDED_POPULAR_LIBRARY_PILOT_AI_ENABLED_RUN.md`](BOUNDED_POPULAR_LIBRARY_PILOT_AI_ENABLED_RUN.md), [`BOUNDED_POPULAR_LIBRARY_PILOT_OUTPUT_TRIAGE.md`](BOUNDED_POPULAR_LIBRARY_PILOT_OUTPUT_TRIAGE.md), [`BOUNDED_POPULAR_LIBRARY_PILOT_AUTHOR_HANDOFF.md`](BOUNDED_POPULAR_LIBRARY_PILOT_AUTHOR_HANDOFF.md), [`BOUNDED_POPULAR_LIBRARY_PILOT_EXIT_DECISION.md`](BOUNDED_POPULAR_LIBRARY_PILOT_EXIT_DECISION.md), [`TARGETED_PILOT_QUALITY_FOLLOW_UP_PLAN.md`](TARGETED_PILOT_QUALITY_FOLLOW_UP_PLAN.md), [`TARGETED_PILOT_QUALITY_PASS.md`](TARGETED_PILOT_QUALITY_PASS.md), [`TARGETED_PILOT_BOUNDED_RERUN_GATE.md`](TARGETED_PILOT_BOUNDED_RERUN_GATE.md), [`TARGETED_PILOT_QUALITY_FOLLOW_UP_EXIT_DECISION.md`](TARGETED_PILOT_QUALITY_FOLLOW_UP_EXIT_DECISION.md), [`AI_DRAFT_BLOCKER_FOLLOW_UP_PLAN.md`](AI_DRAFT_BLOCKER_FOLLOW_UP_PLAN.md), [`AI_DRAFT_BLOCKER_FOLLOW_UP_PASS.md`](AI_DRAFT_BLOCKER_FOLLOW_UP_PASS.md), [`AI_DRAFT_BLOCKER_BOUNDED_RERUN_GATE.md`](AI_DRAFT_BLOCKER_BOUNDED_RERUN_GATE.md), [`POST_BLOCKER_FOLLOW_UP_EXIT_DECISION.md`](POST_BLOCKER_FOLLOW_UP_EXIT_DECISION.md), [`DOCC2CONTEXT_AI_DRAFT_TARGETED_FOLLOW_UP_PLAN.md`](DOCC2CONTEXT_AI_DRAFT_TARGETED_FOLLOW_UP_PLAN.md), [`DOCC2CONTEXT_AI_DRAFT_TARGETED_FOLLOW_UP_PASS.md`](DOCC2CONTEXT_AI_DRAFT_TARGETED_FOLLOW_UP_PASS.md), [`DOCC2CONTEXT_AI_DRAFT_SAME_SCOPE_BOUNDED_RERUN_GATE.md`](DOCC2CONTEXT_AI_DRAFT_SAME_SCOPE_BOUNDED_RERUN_GATE.md), [`DOCC2CONTEXT_FOLLOW_UP_EXIT_DECISION.md`](DOCC2CONTEXT_FOLLOW_UP_EXIT_DECISION.md), [`RESTORED_CHECKOUT_RERUN_EVIDENCE.md`](RESTORED_CHECKOUT_RERUN_EVIDENCE.md), [`LARGER_CURATED_CORPUS_PLANNING_PHASE.md`](LARGER_CURATED_CORPUS_PLANNING_PHASE.md), [`LARGER_CURATED_CORPUS_AI_ENABLED_GATE.md`](LARGER_CURATED_CORPUS_AI_ENABLED_GATE.md), [`AUTONOMOUS_CANDIDATE_BATCH.md`](AUTONOMOUS_CANDIDATE_BATCH.md) |
| Operational MVP validation | Phase 43 validates whether the current pipeline produces valid, repository-specific starter packages over a bounded pinned multi-ecosystem corpus before broader autonomous scraping or real adapter execution. P43-T2 adds the machine-readable `SpecHarvesterOperationalMVPValidationPlan` fixture; P43-T3 adds the companion `SpecHarvesterOperationalMVPValidationReport` fixture for per-repository result, quality, stop-policy, and handoff readiness fields; P43-T4 records the real local static-only baseline over xyflow, FastAPI, and Gin pinned checkouts; P43-T5 records the live local LM Studio AI-enabled comparison while keeping all AI draft/enrichment output proposal-only; P43-T6 adds author handoff summaries for valid, reviewable, manual-correction, and do-not-promote outcomes; P43-T7 selects `needs_quality_hardening` before broader autonomous popular-library scraping; P44-T1 triages the shared `package_set_id_missing` AI draft warning as an AI proposal shape issue; P44-T2 reviews proposal-only AI enrichment quality; P44-T3 accepts xyflow partial interface and fork-origin caveats for bounded rerun evidence while keeping them registry-promotion blockers; P44-T4 records the quality-hardened static-only and AI-enabled rerun comparison; P44-T5 selects another quality pass before bounded popular-library scraping; P45-T3 records the post-fix bounded corpus rerun after AI draft shape hardening; P45-T4 records the post-fix readiness decision and keeps bounded popular-library scraping unapproved until remaining AI draft quality signals are resolved or accepted as non-blocking; P45-T7 records the targeted P45-T5/P45-T6 rerun showing AI draft blockers resolved while preserving a remaining AI enrichment warning for P45-T8 readiness review; P45-T8 selects Phase 46 bounded popular-library pilot readiness while carrying Gin `model_evidence_path_unsupported` into triage. | [`OPERATIONAL_MVP_VALIDATION_PLAN.md`](OPERATIONAL_MVP_VALIDATION_PLAN.md), [`OPERATIONAL_MVP_VALIDATION_PLAN_FIXTURE.md`](OPERATIONAL_MVP_VALIDATION_PLAN_FIXTURE.md), [`OPERATIONAL_MVP_VALIDATION_REPORT_FIXTURE.md`](OPERATIONAL_MVP_VALIDATION_REPORT_FIXTURE.md), [`OPERATIONAL_MVP_STATIC_ONLY_BASELINE.md`](OPERATIONAL_MVP_STATIC_ONLY_BASELINE.md), [`OPERATIONAL_MVP_AI_ENABLED_COMPARISON.md`](OPERATIONAL_MVP_AI_ENABLED_COMPARISON.md), [`OPERATIONAL_MVP_AUTHOR_HANDOFF_SUMMARIES.md`](OPERATIONAL_MVP_AUTHOR_HANDOFF_SUMMARIES.md), [`OPERATIONAL_MVP_EXIT_REPORT.md`](OPERATIONAL_MVP_EXIT_REPORT.md), [`OPERATIONAL_MVP_WARNING_TRIAGE.md`](OPERATIONAL_MVP_WARNING_TRIAGE.md), [`OPERATIONAL_MVP_AI_PROPOSAL_QUALITY_REVIEW.md`](OPERATIONAL_MVP_AI_PROPOSAL_QUALITY_REVIEW.md), [`OPERATIONAL_MVP_XYFLOW_CAVEAT_RESOLUTION.md`](OPERATIONAL_MVP_XYFLOW_CAVEAT_RESOLUTION.md), [`OPERATIONAL_MVP_QUALITY_HARDENED_RERUN.md`](OPERATIONAL_MVP_QUALITY_HARDENED_RERUN.md), [`OPERATIONAL_MVP_POST_HARDENING_READINESS_DECISION.md`](OPERATIONAL_MVP_POST_HARDENING_READINESS_DECISION.md), [`OPERATIONAL_MVP_AI_DRAFT_SHAPE_RERUN.md`](OPERATIONAL_MVP_AI_DRAFT_SHAPE_RERUN.md), [`OPERATIONAL_MVP_POST_FIX_READINESS_DECISION.md`](OPERATIONAL_MVP_POST_FIX_READINESS_DECISION.md), [`OPERATIONAL_MVP_TARGETED_AI_DRAFT_POLICY_RERUN.md`](OPERATIONAL_MVP_TARGETED_AI_DRAFT_POLICY_RERUN.md), [`OPERATIONAL_MVP_TARGETED_HARDENING_READINESS_DECISION.md`](OPERATIONAL_MVP_TARGETED_HARDENING_READINESS_DECISION.md), [`AUTHOR_READY_DRAFT_QUALITY_REPORT.md`](AUTHOR_READY_DRAFT_QUALITY_REPORT.md), [`AUTONOMOUS_CANDIDATE_BATCH.md`](AUTONOMOUS_CANDIDATE_BATCH.md) |
...
5. Use [`SELECTED_CANDIDATE_HANDOFF_PROPOSAL.md`](SELECTED_CANDIDATE_HANDOFF_PROPOSAL.md)
   [`PORTABLE_SEMANTIC_PROPOSAL_RECORDS.md`](PORTABLE_SEMANTIC_PROPOSAL_RECORDS.md),
