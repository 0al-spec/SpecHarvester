...
| Local review decision service | Stores schema-valid catalog-bound decisions behind a loopback Origin/CSRF boundary with atomic current state, immutable history, stale-write rejection, and restart recovery. | [`LOCAL_REVIEW_DECISION_SERVICE.md`](LOCAL_REVIEW_DECISION_SERVICE.md) |
