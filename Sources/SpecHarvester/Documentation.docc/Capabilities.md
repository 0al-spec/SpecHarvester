...
| Relevant observed-intent routing | Selects up to 16 positively matched observed SpecPM intents from a pinned non-canonical snapshot and rejects specific-purpose proposals that reuse only generic implementation-shape intents. | <doc:RelevantIntentRouting> |
...
| Larger curated corpus source planning | Bounded operator-curated larger corpus source plan with manifest criteria, pinned revisions, local checkout requirements, inclusion signals, exclusion stop conditions, and no-authority boundaries before readiness, static-only, or AI-enabled gates run. | <doc:LargerCuratedCorpusSourcePlan> |
| Larger curated corpus checkout readiness | Verifies all selected larger-corpus sources have operator-provided pinned local checkouts and matching revisions before allowing the static-only gate. | <doc:LargerCuratedCorpusCheckoutReadiness> |
| Larger curated corpus static-only gate | Runs the larger curated corpus deterministic static-only gate over all 12 selected sources, preserving preview-only candidates, relation proposals, caveats, and no-AI/no-adapter/no-registry-authority boundaries before allowing the AI-enabled proposal-only gate. | <doc:LargerCuratedCorpusStaticOnlyGate> |
| Larger curated corpus AI-enabled gate | Runs the larger curated corpus through local LM Studio proposal-only AI draft and enrichment paths, preserving provider metadata, warning/blocker evidence, raw prompt/response/chain-of-thought non-persistence, and no-registry-authority boundaries before output triage. | <doc:LargerCuratedCorpusAIEnabledGate> |
| Hyperprompt single-package AI draft fallback | Converts reproducible single-package AI draft JSON repair exhaustion into warning-level proposal-only fallback evidence from deterministic inventory while preserving diagnostics and keeping multi-package malformed output blocking. | <doc:HyperpromptAIDraftSinglePackageFallback> |
| Larger curated corpus output triage | Classifies larger curated corpus static packages, relation proposals, AI draft sidecars, AI enrichment sidecars, AI-enriched previews, warnings, and caveats into selected, deferred, and do-not-promote outcomes before the exit decision. | <doc:LargerCuratedCorpusOutputTriage> |
| Larger curated corpus exit decision | Completes Phase 51 as author-review evidence ready without approving further larger corpus expansion, registry promotion, package acceptance, relation acceptance, or `preview_only` removal. | <doc:LargerCuratedCorpusExitDecision> |
| Controlled 50-100 repository corpus plan | Defines a staged 5/20/50-100 repository rollout, Codex Spark external-model boundary, curated source policy, quality thresholds, and proposal-only gates before new checkout acquisition or batch execution. | <doc:ControlledRepositoryCorpusPlan> |
| Codex Spark external-model adapter contract | Defines the future `codex exec` proposal-only invocation, evidence staging, final-message JSON Schema, receipt and rejection policy, and external `--model-output` handoff without running Codex or replacing LM Studio. | <doc:CodexSparkExternalModelAdapterContract> |
| Five-repository controlled calibration | Runs static-only, LM Studio JSON Schema, and read-only schema-validated Codex Spark proposal-only controls over five pinned checkouts; records quality metrics, bounded receipts, external-provider logging caveat, and the P52-T4 decision without registry authority. | <doc:FiveRepositoryControlledCalibration> |
| Twenty-repository controlled pilot | Runs the Phase 52 twenty-source static-first pilot with proposal-only LM Studio and Codex Spark controls, digest-bound author review, and an explicit P52-T5 readiness decision. | <doc:TwentyRepositoryControlledPilot> |
| Final corpus checkout readiness | Fixes the final 50-source manifest and verifies clean pinned local checkouts, provenance, license evidence, tracked-file size budgets, and ecosystem/shape coverage before P52-T6. | <doc:FinalCorpusCheckoutReadiness> |
| Final corpus static-only gate | Runs all 50 approved sources through deterministic static collection and preview drafting, records explicit failures and artifact digests, enforces the 95% completion threshold, and keeps AI and adapters disabled before P52-T7. | <doc:FinalCorpusStaticOnlyGate> |
| Mass repository campaign plan | Defines the 100-source, four-wave campaign contract with `gpt-5.3-codex-spark` as sole proposal-only worker, two-worker concurrency, bounded retries/budgets, explicit scale-out review gates, and no-registry-authority boundaries. | <doc:MassRepositoryCampaignPlan> |
| Local candidate review Workbench contract | Defines the local-first 100-candidate review product, roles, trust zones, decision lifecycle, hostile-content controls, digest-bound portable input, and read-only SpecPM preflight boundary. | <doc:LocalCandidateReviewWorkbenchContract> |
| Local candidate review Workbench schemas | Defines versioned JSON Schema records for catalog, detail, static-versus-AI comparison, reviewer decisions, reason taxonomy, and portable non-authoritative export. | <doc:LocalCandidateReviewWorkbenchSchemas> |
| Deterministic local candidate review catalog | Safely validates a portable handoff archive and emits a packet-digest-bound static catalog with six review facets. | <doc:LocalCandidateReviewCatalog> |
| Local candidate review browser | Renders a local candidate-only static browser with corpus summary, facets, search, sort, and resumable queue state. | <doc:LocalCandidateReviewBrowser> |
| Local candidate review details | Builds schema-valid, digest-bound candidate details and static-versus-Codex Spark comparison evidence, then displays selected records as inert local text. | <doc:LocalCandidateReviewDetails> |
| Local review decision service | Stores schema-valid catalog-bound decisions behind a loopback Origin/CSRF boundary with atomic current state, immutable history, stale-write rejection, and restart recovery. | <doc:LocalReviewDecisionService> |
| Local SpecPM intake bridge | Revalidates current approved reviewer decisions and portable packet bindings, reconstructs preview candidates safely, runs bounded read-only SpecPM validation, and emits non-authoritative intake proposal evidence with zero registry mutations. | <doc:LocalSpecPMIntakeBridge> |
| Local candidate review Workbench E2E validation | Exercises the full 100-candidate browser, decision, restart, hostile-content, Origin/CSRF, integrity, and read-only SpecPM path across all four campaign waves. | <doc:LocalCandidateReviewWorkbenchE2E> |
| AI semantic-author product contract | Defines provider-neutral, evidence-grounded semantic proposal responsibilities for Codex 5.3 Spark and LM Studio, experimental-intent states, explicit reviewer authority, bounded materialization, privacy, and no-publication boundaries. | <doc:AISemanticAuthorContract> |
| AI semantic-author schemas | Defines provider-neutral semantic request, proposal, intent, evidence, reviewer-edit, and proposal-only materialization-decision records. | <doc:AISemanticAuthorSchemas> |
| Semantic author input pack | Builds a bounded P55 request from allowlisted candidate evidence and observed intents without provider execution. | <doc:SemanticAuthorInputPack> |
| Bounded corpus runs | Important multi-ecosystem repository/package-family targets selected with explicit importance signals and exclusion rules, recorded in a machine-readable corpus plan, explainable selection report, dry-run readiness gate, P46 bounded popular-library pilot manifest, P46 static-only pilot result, P46 proposal-only AI-enabled pilot result, P46 output triage, P46 author handoff, P46 exit decision, P47 targeted quality follow-up plan, P47 targeted quality pass, P47 bounded rerun gate, P47 targeted quality follow-up exit decision, P48 AI draft blocker follow-up plan, P48 AI draft blocker follow-up pass, P48 bounded rerun gate, P48 post-blocker exit decision, P49 docc2context AI draft targeted follow-up plan, P49 docc2context AI draft targeted follow-up pass, P49 same-scope bounded rerun gate evidence, P49 docc2context follow-up exit decision, P50 restored-checkout rerun evidence, and P51 larger curated corpus planning phase, then operator-selected local checkout batches with deterministic and optional live local-model paths. | <doc:CorpusSelectionPolicy>, <doc:SpecHarvesterCorpusPlan>, <doc:MultiEcosystemSeedCorpusPlan>, <doc:ExplainableCorpusSelectionReport>, <doc:SelectedCorpusDryRunReadiness>, <doc:BoundedPopularLibraryPilotManifest>, <doc:BoundedPopularLibraryPilotStaticOnlyRun>, <doc:BoundedPopularLibraryPilotAIEnabledRun>, <doc:BoundedPopularLibraryPilotOutputTriage>, <doc:BoundedPopularLibraryPilotAuthorHandoff>, <doc:BoundedPopularLibraryPilotExitDecision>, <doc:TargetedPilotQualityFollowUpPlan>, <doc:TargetedPilotQualityPass>, <doc:TargetedPilotBoundedRerunGate>, <doc:TargetedPilotQualityFollowUpExitDecision>, <doc:AIDraftBlockerFollowUpPlan>, <doc:AIDraftBlockerFollowUpPass>, <doc:AIDraftBlockerBoundedRerunGate>, <doc:PostBlockerFollowUpExitDecision>, <doc:Docc2contextAIDraftTargetedFollowUpPlan>, <doc:Docc2contextAIDraftTargetedFollowUpPass>, <doc:Docc2contextAIDraftSameScopeBoundedRerunGate>, <doc:Docc2contextFollowUpExitDecision>, <doc:RestoredCheckoutRerunEvidence>, <doc:LargerCuratedCorpusPlanningPhase>, <doc:LargerCuratedCorpusAIEnabledGate>, <doc:AutonomousCandidateBatch> |
| Operational MVP validation | Phase 43 validates whether the current pipeline produces valid, repository-specific starter packages over a bounded pinned multi-ecosystem corpus before broader autonomous scraping or real adapter execution. P43-T2 adds the machine-readable `SpecHarvesterOperationalMVPValidationPlan` fixture; P43-T3 adds the companion `SpecHarvesterOperationalMVPValidationReport` fixture for per-repository result, quality, stop-policy, and handoff readiness fields; P43-T4 records the real local static-only baseline over xyflow, FastAPI, and Gin pinned checkouts; P43-T5 records the live local LM Studio AI-enabled comparison while keeping all AI draft/enrichment output proposal-only; P43-T6 adds author handoff summaries for valid, reviewable, manual-correction, and do-not-promote outcomes; P43-T7 selects `needs_quality_hardening` before broader autonomous popular-library scraping; P44-T1 triages the shared `package_set_id_missing` AI draft warning as an AI proposal shape issue; P44-T2 reviews proposal-only AI enrichment quality; P44-T3 accepts xyflow partial interface and fork-origin caveats for bounded rerun evidence while keeping them registry-promotion blockers; P44-T4 records the quality-hardened static-only and AI-enabled rerun comparison; P44-T5 selects another quality pass before bounded popular-library scraping; P45-T3 records the post-fix bounded corpus rerun after AI draft shape hardening; P45-T4 records the post-fix readiness decision and keeps bounded popular-library scraping unapproved until remaining AI draft quality signals are resolved or accepted as non-blocking; P45-T7 records the targeted P45-T5/P45-T6 rerun showing AI draft blockers resolved while preserving a remaining AI enrichment warning for P45-T8 readiness review; P45-T8 selects Phase 46 bounded popular-library pilot readiness while carrying Gin `model_evidence_path_unsupported` into triage. | <doc:OperationalMVPValidationPlan>, <doc:OperationalMVPValidationPlanFixture>, <doc:OperationalMVPValidationReportFixture>, <doc:OperationalMVPStaticOnlyBaseline>, <doc:OperationalMVPAIEnabledComparison>, <doc:OperationalMVPAuthorHandoffSummaries>, <doc:OperationalMVPExitReport>, <doc:OperationalMVPWarningTriage>, <doc:OperationalMVPAIProposalQualityReview>, <doc:OperationalMVPXyflowCaveatResolution>, <doc:OperationalMVPQualityHardenedRerun>, <doc:OperationalMVPPostHardeningReadinessDecision>, <doc:OperationalMVPAIDraftShapeRerun>, <doc:OperationalMVPPostFixReadinessDecision>, <doc:OperationalMVPTargetedAIDraftPolicyRerun>, <doc:OperationalMVPTargetedHardeningReadinessDecision>, <doc:AuthorReadyDraftQualityReport>, <doc:AutonomousCandidateBatch> |
