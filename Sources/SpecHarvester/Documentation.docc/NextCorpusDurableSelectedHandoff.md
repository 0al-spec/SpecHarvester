...
The selected candidates are `serena.core` and `specpm.core`. The deferred
candidates are `transmission.core`, `mcpm.system`, and `specgraph.system`.
...
author/maintainer review with explicit deferral for `transmission.core`,
`mcpm.system`, and `specgraph.system`.
