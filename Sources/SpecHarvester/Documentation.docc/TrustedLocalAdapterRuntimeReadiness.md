...
<doc:TrustedLocalAdapterRunnerSkeleton>, which validates a request and
preflight report, verifies the request digest recorded by preflight, and emits
a deterministic no-execution report. It does not load third-party adapter code
or launch adapter processes.
