...
const state={items:[],details:new Map(),comparisons:new Map(),current:new Map(),reasons:[],cursor:0};const fields=['readiness','warnings','corrected','ecosystem','shape','preflight','review-state'];
