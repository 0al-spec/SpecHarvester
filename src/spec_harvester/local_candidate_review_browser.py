...
<section class="controls" aria-label="Catalog filters"><label class="wide">Search<input id="search" type="search" placeholder="Candidate ID"></label><label>Ecosystem<select id="ecosystem"></select></label><label>Review state<select id="review-state"></select></label><details class="more-filters"><summary>More filters</summary><label>Readiness<select id="readiness"></select></label><label>Warnings<select id="warnings"></select></label><label>Correction<select id="corrected"></select></label><label>Shape<select id="shape"></select></label><label>Preflight<select id="preflight"></select></label><label>Sort<select id="sort"><option value="id">Candidate ID</option><option value="warnings">Warnings</option><option value="ecosystem">Ecosystem</option></select></label></details></section>
